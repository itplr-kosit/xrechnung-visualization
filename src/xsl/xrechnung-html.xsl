...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                    ...
                    <form>
                        <div class="menue" role="navigation">
                            <div role="tablist" class="innen">
                                <div role="none">
                                    <button role="tab" aria-controls="uebersicht" tabindex="0"
                                        aria-selected="true" type="button" class="tab btnAktiv"
                                        id="menueUebersicht" onclick="show(this);">
                                        <span>
                                ...
                                <div role="none">
                                    <button role="tab" aria-controls="details" tabindex="0"
                                        aria-selected="false" type="button" class="tab"
                                        id="menueDetails" onclick="show(this);">
                                        <span>
                                ...
                                <div role="none">
                                    <button role="tab" aria-controls="zusaetze" tabindex="0"
                                        aria-selected="false" type="button" class="tab"
                                        id="menueZusaetze" onclick="show(this)">
                                        <span>
                                ...
                                <div role="none">
                                    <button role="tab" aria-controls="anlagen" tabindex="0"
                                        aria-selected="false" type="button" class="tab"
                                        id="menueAnlagen" onclick="show(this)">
                                        <span>
                                ...
                                <div role="none">
                                    <button role="tab" aria-controls="laufzettel" tabindex="0"
                                        aria-selected="false" type="button" class="tab"
                                        id="menueLaufzettel" onclick="show(this)">
                                        <span>
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    ...
                    <div data-title="BT-39" class="BT-39 boxdaten wert">
                        <xsl:value-of
                            select="xr:SELLER_POSTAL_ADDRESS/xr:Seller_country_subdivision" />
                    </div>
                </div>
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
            ...
            <div id="uebersichtRechnungsuebersicht" class="box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 paddingBottom line1Bottom color2"
                            role="cell">
                            <xsl:value-of select="xrf:_('_net')" />
                        </div>
                        <div data-title="BT-108"
                            class="BT-108 boxdaten rechnungSp3 paddingBottom line1Bottom"
                            role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div data-title="BT-109" class="BT-109 boxdaten rechnungSp3 paddingTop"
                            role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 paddingBottom line1Bottom" role="rowheader">
                            <xsl:value-of
                                select="xrf:_('xr:Invoice_total_VAT_amount_in_accounting_currency')"
                             />
                        </div>
                        <div class="boxdaten rechnungSp2 paddingBottom line1Bottom color2"
                            role="cell" />
                        <div data-title="BT-111"
                            class="BT-111 boxdaten rechnungSp3 paddingBottom line1Bottom"
                            role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div data-title="BT-112" class="BT-112 boxdaten rechnungSp3 paddingTop"
                            role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 paddingBottom line2Bottom color2"
                            role="cell">
                            <xsl:value-of select="xrf:_('_gross')" />
                        </div>
                        <div data-title="BT-114"
                            class="BT-114 boxdaten rechnungSp3 paddingBottom line2Bottom"
                            role="cell">
                            <xsl:value-of
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div data-title="BT-115" class="BT-115 boxdaten rechnungSp3 paddingTop bold"
                            role="cell">
                            <xsl:value-of
        ...
        <div class="boxzeile">
            <div class="uebersichtUmsatzsteuer box">
              ...
              <span class="BT-118" data-title="BT-118">
                        ...
                        <div class="boxdaten rechnungSp2" role="cell" />
                        <div class="boxdaten rechnungSp3" role="cell" />
                    </div>
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1" role="rowheader">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 color2 line1Bottom" role="cell" />
                        <div data-title="BT-119" class="BT-119 boxdaten rechnungSp3 line1Bottom"
                            role="cell">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 color2" role="cell" />
                        <div data-title="BT-117" class="BT-117 boxdaten rechnungSp3 bold"
                            role="cell">
                            <xsl:value-of
            ...
            <div class="uebersichtNachlass box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 bold" role="rowheader">
                            <xsl:value-of
                                select="xrf:_('xr:Document_level_allowance_VAT_category_code')" />:
              <span data-title="BT-95">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 color2 line1Bottom" role="cell" />
                        <div data-title="BT-94" class="BT-94 boxdaten rechnungSp3 line1Bottom"
                            role="cell">
            ...
            <div id="uebersichtZuschlaege" class="box">
                ...
                <div class="boxtabelle boxinhalt" role="table">
                    <div class="rechnungsZeile" role="row">
                        <div class="boxdaten rechnungSp1 bold" role="rowheader">
                            <xsl:value-of
                                select="xrf:_('xr:Document_level_charge_VAT_category_code')" />:
              <span data-title="BT-102" class="BT-102">
                    ...
                    <div class="rechnungsZeile" role="row">
                        ...
                        <div class="boxdaten rechnungSp2 color2 line1Bottom" role="cell" />
                        <div data-title="BT-101" class="BT-101 boxdaten rechnungSp3 line1Bottom"
                            role="cell">
    ...
    <xsl:template name="details">
        <div id="details" class="divHide" role="tabpanel" aria-labelledby="menueDetails"
            tabindex="0">
            <div class="haftungausschluss">
                <xsl:value-of select="xrf:_('_disclaimer')" />
            </div>
    ...
    <xsl:template match="xr:INVOICE_LINE | xr:SUB_INVOICE_LINE">
        <div class="boxtabelle boxabstandtop boxtabelleZweispaltig first">
            <div class="boxzeile">
                <div class="box subBox">
                    ...
                    <div class="boxtabelle boxinhalt borderSpacing" role="list">
                        ...
                        <div class="boxzeile" role="listitem">
                            <div class="boxdaten legende">
                                <xsl:value-of
                                    select="xrf:_('xr:Invoice_line_object_identifier/@scheme_identifier')"
                                 />:
              </div>
                            <div data-title="BT-128-scheme-id"
                                class="BT-128-scheme-id boxdaten wert">
                                <xsl:value-of
                        ...
                        <div class="boxzeile" role="listitem">
                            <div class="boxdaten legende">
                                <xsl:value-of
                                    select="xrf:_('xr:Referenced_purchase_order_line_reference')"
                                 />:
              </div>
                        ...
                        <div class="boxzeile" role="listitem">
                            <div class="boxdaten legende">
                                <xsl:value-of
                                    select="xrf:_('xr:Invoice_line_Buyer_accounting_reference')"
                                 />:
              </div>
                        ...
                        <div role="listitem">
                            ...
                            <div class="boxtabelle borderSpacing" role="list">
                                <div class="boxzeile" role="listitem">
                                    <div class="boxdaten legende">
                                        <xsl:value-of
                                            select="xrf:_('xr:Invoice_line_period_start_date')"
                                         />:
                  </div>
                                ...
                                <div class="boxzeile" role="listitem">
                                    <div class="boxdaten legende">
                                        <xsl:value-of
                                            select="xrf:_('xr:Invoice_line_period_end_date')"
                                         />:
                  </div>
                ...
                <div class="box subBox">
                    <div data-title="BG-29" class="BG-29 boxtitel boxtitelSub" role="heading"
                        aria-level="3">
                    ...
                    <div class="boxtabelle boxinhalt" role="table">
                        ...
                        <div class="rechnungsZeile" role="row">
                            <div class="boxdaten detailSp1 color2" role="rowheader">
                                <xsl:value-of
                                    select="xrf:_('xr:Invoiced_quantity_unit_of_measure_code')" />
                            </div>
                        ...
                        <div class="rechnungsZeile" role="row">
                            ...
                            <div data-title="BT-146" class="BT-146 boxdaten detailSp2 line1Bottom"
                                role="cell">
                                <xsl:value-of
                        ...
                        <div class="rechnungsZeile" role="row">
                            ...
                            <div data-title="BT-131" class="BT-131 boxdaten detailSp2 bold"
                                role="cell">
                                <xsl:value-of
                    ...
                    <div class="boxtabelle boxinhalt noPaddingTop borderSpacing" role="list">
                        ...
                        <div class="boxzeile" role="listitem">
                            <div class="boxdaten legende">
                                <xsl:value-of
                                    select="xrf:_('xr:Item_price_base_quantity_unit_of_measure')"
                                 />:
              </div>
                        ...
                        <div class="boxzeile" role="listitem">
                            ...
                            <div data-title="BT-151" class="BT-151 boxdaten wert">
                                <xsl:value-of
                                    select="xr:LINE_VAT_INFORMATION/xr:Invoiced_item_VAT_category_code"
                                 />
                            </div>
                        </div>
                        <div class="boxzeile" role="listitem">
        ...
        <div class="boxtabelle">
            <div class="boxzeile">
                <div class="box subBox">
                    <div data-title="BG-27" class="BG-27 boxtitel boxtitelSub" role="heading"
                        aria-level="3">
                    ...
                    <xsl:for-each select="xr:INVOICE_LINE_ALLOWANCES">
                        <div class="boxtabelle boxinhalt " role="table">
                            <div class="rechnungsZeile" role="row">
                                <div class="boxdaten detailSp1 color2" role="rowheader">
                                    <xsl:value-of
                                        select="xrf:_('xr:Invoice_line_allowance_base_amount')" />
                                </div>
                                <div data-title="BT-137" class="BT-137 boxdaten detailSp2"
                                    role="cell">
                                    <xsl:value-of
                            ...
                            <div class="rechnungsZeile" role="row">
                                <div class="boxdaten detailSp1 line1Bottom color2" role="rowheader">
                                    <xsl:value-of
                                        select="xrf:_('xr:Invoice_line_allowance_percentage')" />
                                </div>
                                <div data-title="BT-138"
                                    class="BT-138 boxdaten detailSp2 line1Bottom" role="cell">
                                    <xsl:value-of
                            ...
                            <div class="rechnungsZeile" role="row">
                                ...
                                <div data-title="BT-136" class="BT-136 boxdaten detailSp2 bold"
                                    role="cell">
                                    <xsl:value-of
                ...
                <span data-title="BT-139" class="BT-139 bold">
                            ...
                            <div class="color2" role="listitem">
                                <xsl:value-of
                                    select="xrf:_('xr:Invoice_line_allowance_reason_code')" />:
                ...
                <div class="box subBox">
                    <div data-title="BG-28" class="BG-28 boxtitel boxtitelSub" role="heading"
                        aria-level="3">
                    ...
                    <xsl:for-each select="xr:INVOICE_LINE_CHARGES">
                        <div class="boxtabelle boxinhalt " role="table">
                            <div class="rechnungsZeile" role="row">
                                <div class="boxdaten detailSp1 color2" role="rowheader">
                                    <xsl:value-of
                                        select="xrf:_('xr:Invoice_line_charge_base_amount')" />
                                </div>
                                <div data-title="BT-142" class="BT-142 boxdaten detailSp2"
                                    role="cell">
                                    <xsl:value-of
                            ...
                            <div class="rechnungsZeile" role="row">
                                <div class="boxdaten detailSp1 line1Bottom color2" role="rowheader">
                                    <xsl:value-of
                                        select="xrf:_('xr:Invoice_line_charge_percentage')" />
                                </div>
                                <div data-title="BT-143"
                                    class="BT-143 boxdaten detailSp2 line1Bottom" role="cell">
                                    <xsl:value-of
                            ...
                            <div class="rechnungsZeile" role="row">
                                ...
                                <div data-title="BT-141" class="BT-141 boxdaten detailSp2 bold"
                                    role="cell">
                                    <xsl:value-of
        ...
        <div class="boxtabelle">
            <div class="boxzeile">
                <div class="box subBox">
                    <div data-title="BG-31" class="BG-31 boxtitel boxtitelSub" role="heading"
                        aria-level="3">
                                ...
                                <div class="boxtabelle borderSpacing" role="list">
                                    ...
                                    <div class="boxzeile" role="listitem">
                                        ...
                                        <div data-title="BT-154" class="BT-154 boxdaten wert">
                                            <xsl:value-of
                                                select="xr:ITEM_INFORMATION/xr:Item_description" />
                                        </div>
                                    </div>
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_Sellers_identifier')"
                                             />:
                    </div>
                                        <div data-title="BT-155" class="BT-155 boxdaten wert">
                                            <xsl:value-of
                                                select="xr:ITEM_INFORMATION/xr:Item_Sellers_identifier"
                                             />
                                        </div>
                                    </div>
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_Buyers_identifier')"
                                             />:
                    </div>
                                        <div data-title="BT-156" class="BT-156 boxdaten wert">
                                            <xsl:value-of
                                                select="xr:ITEM_INFORMATION/xr:Item_Buyers_identifier"
                                             />
                                        </div>
                                    </div>
                                    <div class="boxtabelle borderSpacing" role="listitem">
                                        <strong class="BG-32" data-title="BG-32">
                                            <xsl:value-of
                                                select="xrf:_('detailsPositionArtikeleigenschaften')"
                                             />:
                    </strong>
                                        <xsl:apply-templates
                                            select="xr:ITEM_INFORMATION/xr:ITEM_ATTRIBUTES" />
                                    </div>
                                </div>
                            </div>
                            <div class="boxabstand" />
                            <div class="boxcell boxZweispaltig">
                                <div class="boxtabelle borderSpacing" role="list">
                                    <div class="boxzeile">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_standard_identifier')"
                                             />:
                    </div>
                                        <div data-title="BT-157" class="BT-157 boxdaten wert">
                                            <xsl:value-of
                                                select="xr:ITEM_INFORMATION/xr:Item_standard_identifier"
                                             />
                                        </div>
                                    </div>
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_standard_identifier/@scheme_identifier')"
                                             />:
                    </div>
                                        <div data-title="BT-157-scheme-id"
                                            class="BT-157-scheme-id boxdaten wert">
                                            <xsl:value-of
                                    ...
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_classification_identifier')"
                                             />:
                    </div>
                                    ...
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_classification_identifier/@scheme_identifier')"
                                             />:
                    </div>
                                        <div data-title="BT-158-scheme-id"
                                            class="BT-158-scheme-id boxdaten wert">
                                            <xsl:value-of
                                    ...
                                    <div class="boxzeile" role="listitem">
                                        <div class="boxdaten legende">
                                            <xsl:value-of
                                                select="xrf:_('xr:Item_country_of_origin')"
                                             />:
                    </div>
                                        <div data-title="BT-159" class="BT-159 boxdaten wert">
                                            <xsl:value-of
                                                select="xr:ITEM_INFORMATION/xr:Item_country_of_origin"
                                             />
                                        </div>
                                    </div>
                                </div>
    ...
    <xsl:template name="zusaetze">
        <div id="zusaetze" class="divHide" role="tabpanel" aria-labelledby="menueZusaetze"
            tabindex="0">
            <div class="haftungausschluss">
                <xsl:value-of select="xrf:_('_disclaimer')" />
            </div>
        ...
        <div id="zusaetzeVerkaeufer" class="box boxZweispaltig">
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Seller_electronic_address/@scheme_identifier')"
                         />:
          </div>
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Seller_tax_registration_identifier/@scheme_identifier')"
                         />:
          </div>
                    <div data-title="BT-32-scheme" class="BT-32-scheme boxdaten wert">
                        <xsl:value-of
                            select="xr:Seller_tax_registration_identifier/@scheme_identifier" />
                    </div>
                </div>
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
        ...
        <div id="zusaetzeKaeufer" class="box boxZweispaltig">
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Buyer_electronic_address/@scheme_identifier')"
                         />:
          </div>
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Buyer_legal_registration_identifier/@scheme_identifier')"
                         />:
          </div>
        ...
        <div id="zusaetzeLieferung" class="box boxZweispaltig">
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Deliver_to_location_identifier/@scheme_identifier')"
                         />:
          </div>
                ...
                <div class="boxzeile" role="listitem">
                    ...
                    <div data-title="BT-72" class="BT-72 boxdaten wert">
                        <xsl:value-of
                            select="format-date(xr:Actual_delivery_date, xrf:_('date-format'))" />
                    </div>
                </div>
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                ...
                <div class="boxzeile" role="listitem">
                    ...
                    <div data-title="BT-79" class="BT-79 boxdaten wert">
                        <xsl:value-of
                            select="xr:DELIVER_TO_ADDRESS/xr:Deliver_to_country_subdivision" />
                    </div>
                </div>
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    ...
                    <div data-title="BT-23" class="BT-23 boxdaten wert">
                        <xsl:value-of
                            select="xr:PROCESS_CONTROL/xr:Business_process_type_identifier" />
                    </div>
                </div>
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Invoiced_object_identifier/@scheme_identifier')"
                         />:
          </div>
        ...
        <div id="zusaetzeZahlungsempfaenger" class="box boxZweispaltig">
            ...
            <div class="boxtabelle boxinhalt borderSpacing" role="list">
                ...
                <div class="boxzeile" role="listitem">
                    <div class="boxdaten legende">
                        <xsl:value-of
                            select="xrf:_('xr:Payee_legal_registration_identifier/@scheme_identifier')"
                         />:
          </div>
    ...
    <xsl:template name="anlagen">
        <div id="anlagen" class="divHide" role="tabpanel" aria-labelledby="menueAnlagen"
            tabindex="0">
            <div class="haftungausschluss">
                <xsl:value-of select="xrf:_('_disclaimer')" />
            </div>
        ...
        <div class="boxtabelle boxinhalt borderSpacing" role="list">
            ...
            <div class="boxzeile" role="listitem">
                ...
                <div data-title="BT-125" class="BT-125 boxdaten wert">
                    <a href="#"
                        onClick="downloadData('{translate(xr:Supporting_document_reference, ' ', '-')}')">
                        <xsl:value-of select="xrf:_('_open')" />
                    </a>
                </div>
                <div id="{translate(xr:Supporting_document_reference, ' ', '-')}"
