...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/xr:invoice">
	...
	<form>
	  <div class="menue">
	    <div class="innen">
	      <button type="button" class="tab" id="menueUebersicht" onclick="show(this);"><xsl:value-of select="xrf:_('Übersicht')"/></button>
	      <button type="button" class="tab" id="menueDetails" onclick="show(this);"><xsl:value-of select="xrf:_('Details')"/></button>
              <button type="button" class="tab" id="menueZusaetze" onclick="show(this)"><xsl:value-of select="xrf:_('Zusätze') "/></button>
              <button type="button" class="tab" id="menueAnlagen" onclick="show(this)"><xsl:value-of select="xrf:_('Anlagen')"/></button>
              <button type="button" class="tab" id="menueLaufzettel" onclick="show(this)"><xsl:value-of select="xrf:_('Laufzettel')"/></button>
	    </div>
	  </div>
	</form>
	<div class="inhalt">
  ...
  <xsl:template name="uebersicht">
	    <div id="uebersicht" class="divShow">
	      <div class="haftungausschluss"><xsl:value-of select="xrf:_('Wir übernehmen keine Haftung für die Richtigkeit der Daten.')"/></div>
  ...
  <xsl:template name="uebersichtKaeufer" match="xr:BUYER">
            <div id="uebersichtKaeufer" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Telefon')"/>:</div>
                  <div id="BT-57" title="BT-57" class="boxdaten wert"><xsl:value-of select="xr:BUYER_CONTACT/xr:Buyer_contact_telephone_number"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('E-Mail-Adresse')"/>:</div>
  ...
  <xsl:template name="uebersichtVerkaeufer" match="xr:SELLER">
            <div id="uebersichtVerkaeufer" class="box boxZweispaltig">
              <div id="BG-4" title="BG-4" class="boxtitel"><xsl:value-of select="xrf:_('Informationen zum Verkäufer')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Firmenname')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Ländercode')"/>:</div>
  ...
  <xsl:template name="uebersichtRechnungsinfo">
          <div class="boxzeile">
            <div id="uebersichtRechnungsinfo" class="box box1v2">
              <div class="boxtitel"><xsl:value-of select="xrf:_('Rechnungsdaten')"/></div>
              <div class="boxtabelle boxinhalt">
                <div class="boxcell boxZweispaltig">
                  <div class="boxtabelle borderSpacing">
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Rechnungsnummer')"/>:</div>
                      <div id="BT-1" title="BT-1" class="boxdaten wert"><xsl:value-of select="xr:Invoice_number"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Rechnungsdatum')"/>:</div>
                      <div id="BT-2" title="BT-2" class="boxdaten wert"><xsl:value-of select="format-date(xr:Invoice_issue_date,xrf:_('date-format'))"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Rechnungsart')"/>:</div>
                      <div id="BT-3" title="BT-3" class="boxdaten wert"><xsl:value-of select="xr:Invoice_type_code"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Währung')"/>:</div>
                      <div id="BT-5" title="BT-5" class="boxdaten wert"><xsl:value-of select="xr:Invoice_currency_code"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Abrechnungsdatum der Umsatzsteuer')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Code des Umsatzsteuer-Abrechnungsdatums')"/>:</div>
                    <div id="BT-8" title="BT-8" class="boxdaten wert"><xsl:value-of select="xr:Value_added_tax_point_date_code"/></div>
                  </div>
                  </div>
                  <h4><xsl:value-of select="xrf:_('Abrechnungszeitraum')"/>:</h4>
                  <div class="boxtabelle borderSpacing">
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('von')"/>:</div>
                      <div id="BT-73" title="BT-73" class="boxdaten wert"><xsl:value-of select="format-date(xr:INVOICING_PERIOD/xr:Invoicing_period_start_date,xrf:_('date-format'))"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('bis')"/>:</div>
                      <div id="BT-74" title="BT-74" class="boxdaten wert"><xsl:value-of select="format-date(xr:INVOICING_PERIOD/xr:Invoicing_period_end_date,xrf:_('date-format'))"/></div>
                    </div>
                  </div>
                </div>
                <div class="boxabstand"></div>
  ...
  <xsl:template match="xr:PRECEDING_INVOICE_REFERENCE">
                  <div class="boxtabelle borderSpacing">
                    ...
                    <div class="boxzeile">
                      <div class="boxdaten legende"><xsl:value-of select="xrf:_('Rechnungsdatum')"/>:</div>
                      <div id="BT-26" title="BT-26" class="boxdaten wert"><xsl:value-of select="(format-date,xr:Preceding_Invoice_issue_date,xrf:_('date-format'))"/></div>
                    </div>
                  </div>
  </xsl:template>
  ...
  <xsl:template name="uebersichtRechnungsuebersicht">
          <div class="boxzeile">
            <div id="uebersichtRechnungsuebersicht" class="box">
              <div id="BG-22" title="BG-22" class="boxtitel"><xsl:value-of select="xrf:_('Gesamtbeträge der Rechnung')"/></div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Summe aller Positionen')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-106" title="BT-106" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Sum_of_Invoice_line_net_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Summe Nachlässe')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-107" title="BT-107" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Sum_of_allowances_on_document_level,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line1Bottom"><xsl:value-of select="xrf:_('Summe Zuschläge')"/></div>
                    <div class="boxdaten rechnungSp2 paddingBottom line1Bottom color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-108" title="BT-108" class="boxdaten rechnungSp3 paddingBottom line1Bottom"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Sum_of_charges_on_document_level,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop"><xsl:value-of select="xrf:_('Gesamtsumme')"/></div>
                    <div class="boxdaten rechnungSp2 paddingTop color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-109" title="BT-109" class="boxdaten rechnungSp3 paddingTop"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Invoice_total_amount_without_VAT,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Summe Umsatzsteuer')"/></div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-110" title="BT-110" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Invoice_total_VAT_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line1Bottom"><xsl:value-of select="xrf:_('Summe Umsatzsteuer in Abrechnungswährung')"/></div>
                    <div class="boxdaten rechnungSp2 paddingBottom line1Bottom color2"></div>
                    <div id="BT-111" title="BT-111" class="boxdaten rechnungSp3 paddingBottom line1Bottom"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Invoice_total_VAT_amount_in_accounting_currency,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop"><xsl:value-of select="xrf:_('Gesamtsumme')"/></div>
                    <div class="boxdaten rechnungSp2 paddingTop color2"><xsl:value-of select="xrf:_('brutto')"/></div>
                    <div id="BT-112" title="BT-112" class="boxdaten rechnungSp3 paddingTop"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Invoice_total_amount_with_VAT,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Gezahlter Betrag')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('brutto')"/></div>
                    <div id="BT-113" title="BT-113" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Paid_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line2Bottom"><xsl:value-of select="xrf:_('Rundungsbetrag')"/></div>
                    <div class="boxdaten rechnungSp2 paddingBottom line2Bottom color2"><xsl:value-of select="xrf:_('brutto')"/></div>
                    <div id="BT-114" title="BT-114" class="boxdaten rechnungSp3 paddingBottom line2Bottom"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Rounding_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop bold"><xsl:value-of select="xrf:_('Fälliger Betrag')"/></div>
                    <div class="boxdaten rechnungSp2 paddingTop color2"><xsl:value-of select="xrf:_('brutto')"/></div>
                    <div id="BT-115" title="BT-115" class="boxdaten rechnungSp3 paddingTop bold"><xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Amount_due_for_payment,$amount-picture,$lang)"/></div>
                  </div>
              </div>
            </div>
	  </div>
  ...
  <xsl:template name="uebersichtUmsatzsteuer" match="xr:VAT_BREAKDOWN">
          <div class="boxzeile">
            <div id="uebersichtUmsatzsteuer" class="box">
              <div id="BG-23" title="BG-23" class="boxtitel"><xsl:value-of select="xrf:_('Aufschlüsselung der Umsatzsteuer auf Ebene der Rechnung')"/></div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="xrf:_('Umsatzsteuerkategorie')"/>: <span id="BT-118" title="BT-118"><xsl:value-of select="xr:VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Gesamtsumme')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-116" title="BT-116" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:VAT_category_taxable_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 line1Bottom"><xsl:value-of select="xrf:_('Umsatzsteuersatz')"/></div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Umsatzsteuerbetrag')"/></div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-117" title="BT-117" class="boxdaten rechnungSp3 bold"><xsl:value-of select="format-number(xr:VAT_category_tax_amount,$amount-picture,$lang)"/></div>
                  </div>
              </div>

              <div class="grund">
                <div><xsl:value-of select="xrf:_('Befreiungsgrund')"/>: <span id="BT-120" title="BT-120" class="bold"><xsl:value-of select="xr:VAT_exemption_reason_text"/></span></div>
                <div><xsl:value-of select="xrf:_('Kennung für den Befreiungsgrund')"/>: <span id="BT-121"  title="BT-121" class="bold"><xsl:value-of select="xr:VAT_exemption_reason_code"/></span></div>
              </div>
            </div>
	  </div>
  </xsl:template>
  ...
  <xsl:template name="uebersichtNachlass" match="xr:DOCUMENT_LEVEL_ALLOWANCES">
          <div class="boxzeile">
            <div id="uebersichtNachlass" class="box">
              <div id="BG-20" title="BG-20" class="boxtitel"><xsl:value-of select="xrf:_('Nachlass auf Ebene der Rechnung')"/></div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="xrf:_('Umsatzsteuerkategorie des Nachlasses')"/>: <span title="BT-95"><xsl:value-of select="xr:Document_level_allowance_VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Grundbetrag')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-93" title="BT-93" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:Document_level_allowance_base_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 line1Bottom"><xsl:value-of select="xrf:_('Prozentsatz')"/></div>
                    <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Nachlass')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-92" title="BT-92" class="boxdaten rechnungSp3 bold"><xsl:value-of select="format-number(xr:Document_level_allowance_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Umsatzsteuersatz des Nachlasses')"/></div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-96" title="BT-96" class="boxdaten rechnungSp3"><xsl:value-of select="xr:Document_level_allowance_VAT_rate"/></div>
                  </div>
              </div>
              <div class="grund">
                <div><xsl:value-of select="xrf:_('Grund für den Nachlass')"/>: <span id="BT-97" title="BT-97" class="bold"><xsl:value-of select="xr:Document_level_allowance_reason"/></span></div>
                <div><xsl:value-of select="xrf:_('Document level allowance reason code')"/>: <span id="BT-98" title="BT-98" class="bold"><xsl:value-of select="xr:Document_level_allowance_reason_code"/></span></div>
              </div>
            </div>
	  </div>
	  <div class="boxabstand"></div>
  ...
  <xsl:template name="uebersichtZuschlaege" match="xr:DOCUMENT_LEVEL_CHARGES">
          <div class="boxzeile">
            <div id="uebersichtZuschlaege" class="box">
              <div id="BG-21" title="BG-21" class="boxtitel"><xsl:value-of select="xrf:_('Zuschlag auf Ebene der Rechnung')"/></div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold"><xsl:value-of select="xrf:_('Umsatzsteuerkategorie des Zuschlages')"/>: <span title="BT-102"><xsl:value-of select="xr:Document_level_charge_VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Grundbetrag')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-100" title="BT-100" class="boxdaten rechnungSp3"><xsl:value-of select="format-number(xr:Document_level_charge_base_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 line1Bottom"><xsl:value-of select="xrf:_('Prozentsatz')"/></div>
                    <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Zuschlag')"/></div>
                    <div class="boxdaten rechnungSp2 color2"><xsl:value-of select="xrf:_('netto')"/></div>
                    <div id="BT-99" title="BT-99" class="boxdaten rechnungSp3 bold"><xsl:value-of select="format-number(xr:Document_level_charge_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1"><xsl:value-of select="xrf:_('Umsatzsteuersatz des Zuschlages')"/></div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-103" title="BT-103" class="boxdaten rechnungSp3"><xsl:value-of select="xr:Document_level_charge_VAT_rate"/></div>
                  </div>
              </div>
              <div class="grund">
                <div><xsl:value-of select="xrf:_('Grund für den Zuschlag')"/>: <span id="BT-104" title="BT-104" class="bold"><xsl:value-of select="xr:Document_level_charge_reason"/></span></div>
                <div><xsl:value-of select="xrf:_('Document level charge reason code')"/>: <span id="BT-105" title="BT-105" class="bold"><xsl:value-of select="xr:Document_level_charge_reason_code"/></span></div>
              </div>
            </div>
	  </div>
	  <div class="boxabstand"></div>
  ...
  <xsl:template name="uebersichtZahlungsinformationen">
            <div id="uebersichtZahlungsinformationen" class="box subBox">
              <div title="" class="boxtitel"><xsl:value-of select="xrf:_('Zahlungsdaten')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Skonto; weitere Zahlungsbedingungen')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Fälligkeitsdatum')"/>:</div>
  ...
  <xsl:template name="uebersichtCard">
            <div id="uebersichtCard" class="box subBox">
              <div id="BG-18" title="BG-18" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Karteninformation')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kartennummer')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Karteninhaber')"/>:</div>
  ...
  <xsl:template name="uebersichtLastschrift">
            <div id="uebersichtLastschrift" class="box subBox">
              <div id="BG-19" title="BG-19" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Lastschrift')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Mandatsreferenznr.')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('IBAN')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Gläubiger-ID')"/>:</div>
  ...
  <xsl:template name="uebersichtUeberweisung">
            <div id="uebersichtUeberweisung" class="box subBox">
              <div id="BG-17" title="BG-17" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Überweisung')"/></div>
              <xsl:for-each select="xr:PAYMENT_INSTRUCTIONS/xr:CREDIT_TRANSFER">
              <div class="boxtabelle boxinhalt borderSpacing">
                 <div class="boxzeile">
                   <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kontoinhaber')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('BIC')"/>:</div>
  ...
  <xsl:template name="uebersichtBemerkungen" match="xr:INVOICE_NOTE">
            <div id="uebersichtBemerkungen" class="box">
              <div id="BG-1" title="BG-1" class="boxtitel"><xsl:value-of select="xrf:_('Bemerkung zur Rechnung')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                 <div class="boxzeile">
                   <div class="boxdaten legende"><xsl:value-of select="xrf:_('Betreff')"/>:</div>
                    <div id="BT-21" title="BT-21" class="boxdaten wert"><xsl:value-of select="xr:Invoice_note_subject_code"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Bemerkung')"/>:</div>
  ...
  <xsl:template match="xr:INVOICE_LINE | xr:SUB_INVOICE_LINE">
        <div class="boxtabelle boxabstandtop boxtabelleZweispaltig first">
          <div class="boxzeile">
            <div class="box subBox">
              <div id="BT-126" title="BT-126" class="boxtitel"><xsl:value-of select="xrf:_('Position')"/> <xsl:value-of select="xr:Invoice_line_identifier"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Freitext')"/>:</div>
                    <div id="BT-127" title="BT-127" class="boxdaten wert"><xsl:value-of select="xr:Invoice_line_note"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Objektkennung')"/>:</div>
                    <div id="BT-128" title="BT-128" class="boxdaten wert"><xsl:value-of select="xr:Invoice_line_object_identifier"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Schema der Objektkennung')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Nummer der Auftragsposition')"/>:</div>
                    <div id="BT-132" title="BT-132" class="boxdaten wert"><xsl:value-of select="xr:Referenced_purchase_order_line_reference"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kontierungshinweis')"/>:</div>
                    <div id="BT-133" title="BT-133" class="boxdaten wert"><xsl:value-of select="xr:Invoice_line_Buyer_accounting_reference"/></div>
                  </div>
                <h4 id="BG-26" title="BG-26"><xsl:value-of select="xrf:_('Abrechnungszeitraum')"/>:</h4>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('von')"/>:</div>
                    <div id="BT-134" title="BT-134" class="boxdaten wert"><xsl:value-of select="format-date(xr:INVOICE_LINE_PERIOD/xr:Invoice_line_period_start_date,xrf:_('date-format'))"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende"><xsl:value-of select="xrf:_('bis')"/>:</div>
                    <div id="BT-135" title="BT-135" class="boxdaten wert"><xsl:value-of select="format-date(xr:INVOICE_LINE_PERIOD/xr:Invoice_line_period_end_date,xrf:_('date-format'))"/></div>
                  </div>
              </div>
            </div>
            <div class="box subBox">
              <div id="BG-29" title="BG-29" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Preiseinzelheiten')"/></div>
              <div class="boxtabelle boxinhalt">
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Menge')"/></div>
                  <div id="BT-129" title="BT-129" class="boxdaten detailSp2"><xsl:value-of select="xr:Invoiced_quantity"/></div>
                </div>
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Einheit')"/></div>
                  <div id="BT-130" title="BT-130" class="boxdaten detailSp2"><xsl:value-of select="xr:Invoiced_quantity_unit_of_measure_code"/></div>
                </div>
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 line1Bottom color2"><xsl:value-of select="xrf:_('Preis pro Einheit (netto)')"/></div>
                  <div id="BT-146" title="BT-146" class="boxdaten detailSp2 line1Bottom"><xsl:value-of select="format-number(xr:PRICE_DETAILS/xr:Item_net_price,$amount-picture,$lang)"/></div>
                </div>
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Gesamtpreis (netto)')"/></div>
                  <div id="BT-131" title="BT-131" class="boxdaten detailSp2 bold"><xsl:value-of select="format-number(xr:Invoice_line_net_amount,$amount-picture,$lang)"/></div>
                </div>
              </div>
              <div class="boxtabelle boxinhalt noPaddingTop borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Rabatt (netto)')"/>:</div>
                  <div id="BT-147" title="BT-147" class="boxdaten wert"><xsl:value-of select="format-number(xr:PRICE_DETAILS/xr:Item_price_discount,$amount-picture,$lang)"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Listenpreis (netto)')"/>:</div>
                  <div id="BT-148" title="BT-148" class="boxdaten wert"><xsl:value-of select="format-number(xr:PRICE_DETAILS/xr:Item_gross_price,$amount-picture,$lang)"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Anzahl der Einheit')"/>:</div>
                  <div id="BT-149" title="BT-149" class="boxdaten wert"><xsl:value-of select="xr:PRICE_DETAILS/xr:Item_price_base_quantity"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Code der Maßeinheit')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Umsatzsteuer')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende "><xsl:value-of select="xrf:_('Umsatzsteuersatz in Prozent')"/>:</div>
                  <div id="BT-152" title="BT-152" class="boxdaten wert"><xsl:value-of select="format-number(xr:LINE_VAT_INFORMATION/xr:Invoiced_item_VAT_rate,$percentage-picture,$lang)"/>%</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="boxtabelle">
          <div class="boxzeile">
            <div class="box subBox">
              <div id="BG-27" title="BG-27" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Nachlässe auf Ebene der Rechnungsposition')"/></div>
              <xsl:for-each select = "xr:INVOICE_LINE_ALLOWANCES">
                <div class="boxtabelle boxinhalt ">
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Grundbetrag (netto)')"/></div>
                    <div id="BT-137" title="BT-137" class="boxdaten detailSp2"><xsl:value-of select="format-number(xr:Invoice_line_allowance_base_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 line1Bottom color2"><xsl:value-of select="xrf:_('Prozentsatz')"/></div>
                    <div id="BT-138" title="BT-138" class="boxdaten detailSp2 line1Bottom"><xsl:value-of select="format-number(xr:Invoice_line_allowance_percentage,$percentage-picture,$lang)"/>%</div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Nachlass (netto)')"/></div>
                    <div id="BT-136" title="BT-136" class="boxdaten detailSp2 bold"><xsl:value-of select="format-number(xr:Invoice_line_allowance_amount,$amount-picture,$lang)"/></div>
                  </div>
                </div>
                <div class="grundDetail">
                  <div class="color2"><xsl:value-of select="xrf:_('Grund des Nachlasses')"/>: <span id="BT-139" title="BT-139" class="bold"><xsl:value-of select="xr:Invoice_line_allowance_reason"/></span></div>
                  <div class="color2"><xsl:value-of select="xrf:_('Code für den Nachlassgrund')"/>: <span id="BT-140" title="BT-140" class="bold"><xsl:value-of select="xr:Invoice_line_allowance_reason_code"/></span></div>
                </div>
              </xsl:for-each>
            </div>
            <div class="box subBox">
              <div id="BG-28" title="BG-28" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Zuschläge auf Ebene der Rechnungsposition')"/></div>
              <xsl:for-each select = "xr:INVOICE_LINE_CHARGES">
                <div class="boxtabelle boxinhalt ">
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Grundbetrag (netto)')"/></div>
                    <div id="BT-142" title="BT-142" class="boxdaten detailSp2"><xsl:value-of select="format-number(xr:Invoice_line_charge_base_amount,$amount-picture,$lang)"/></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 line1Bottom color2"><xsl:value-of select="xrf:_('Prozentsatz')"/></div>
                    <div id="BT-143" title="BT-143" class="boxdaten detailSp2 line1Bottom"><xsl:value-of select="format-number(xr:Invoice_line_charge_percentage,$percentage-picture,$lang)"/>%</div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2"><xsl:value-of select="xrf:_('Zuschlag (netto)')"/></div>
                    <div id="BT-141" title="BT-141" class="boxdaten detailSp2 bold"><xsl:value-of select="format-number(xr:Invoice_line_charge_amount,$amount-picture,$lang)"/></div>
                  </div>
                </div>
                <div class="grundDetail">
                  <div class="color2"><xsl:value-of select="xrf:_('Grund des Zuschlags')"/>: <span id="BT-144" title="BT-144" class="bold"><xsl:value-of select="xr:Invoice_line_charge_reason"/></span></div>
                  <div class="color2"><xsl:value-of select="xrf:_('Code für den Zuschlagsgrund')"/>: <span id="BT-145" title="BT-145" class="bold"><xsl:value-of select="xr:Invoice_line_charge_reason_code"/></span></div>
                </div>
              </xsl:for-each>
            </div>
          </div>
        ...
        <div class="boxtabelle">
          <div class="boxzeile">
            <div class="box subBox">
              <div id="BG-31" title="BG-31" class="boxtitel boxtitelSub"><xsl:value-of select="xrf:_('Artikelinformationen')"/></div>
              <div class="boxtabelle boxinhalt ">
                <div class="boxzeile">
                 <div class="boxcell boxZweispaltig">
                  <div class="boxtabelle borderSpacing">
                    <div class="boxzeile">
                      <div class="boxdaten legende "><xsl:value-of select="xrf:_('Bezeichnung')"/>:</div>
                      <div id="BT-153" title="BT-153" class="boxdaten wert bold"><xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_name"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende "><xsl:value-of select="xrf:_('Beschreibung')"/>:</div>
                      <div id="BT-154" title="BT-154" class="boxdaten wert"><xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_description"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende "><xsl:value-of select="xrf:_('Artikelnummer')"/>:</div>
                      <div id="BT-155" title="BT-155" class="boxdaten wert"><xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_Sellers_identifier"/></div>
                    </div>
                    <div class="boxzeile">
                      <div class="boxdaten legende "><xsl:value-of select="xrf:_('Artikelkennung des Käufers')"/>:</div>
                      <div id="BT-156" title="BT-156" class="boxdaten wert"><xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_Buyers_identifier"/></div>
                    </div>
                    <h4 id="BG-32" title="BG-32"><xsl:value-of select="xrf:_('Eigenschaften des Artikels')"/>:</h4>
		    <xsl:apply-templates select="xr:ITEM_INFORMATION/xr:ITEM_ATTRIBUTES" />
                ...
                <div class="boxcell boxZweispaltig">
                 <div class="boxtabelle borderSpacing">
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Artikelkennung')"/>:</div>
                    <div id="BT-157" title="BT-157" class="boxdaten wert"><xsl:value-of select="xr:ITEM_INFORMATION/xr:Item_standard_identifier"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Schema der Artikelkennung')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Code der Artikelklassifizierung')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Kennung zur Bildung des Schemas')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Version zur Bildung des Schemas')"/>:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende "><xsl:value-of select="xrf:_('Code des Herkunftslandes')"/>:</div>
  ...
  <xsl:template name="zusaetzeVerkaeufer" match="xr:SELLER" mode="zusaetze">
            <div id="zusaetzeVerkaeufer" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Abweichender Handelsname')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Elektronische Adresse')"/>:</div>
                  <div id="BT-34" title="BT-34" class="boxdaten wert"><xsl:value-of select="xr:Seller_electronic_address"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Schema der elektronischen Adresse')"/>:</div>
  ...
  <xsl:template name="zusaetzeSteuervertreter" match="xr:SELLER_TAX_REPRESENTATIVE_PARTY">
            <div id="zusaetzeSteuervertreter" class="box boxZweispaltig">
              <div id="BG-11" title="BG-11" class="boxtitel"><xsl:value-of select="xrf:_('Steuervertreter des Verkäufers')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Name')"/>:</div>
  ...
  <xsl:template name="zusaetzeKaeufer" match="xr:BUYER" mode="zusaetze">
            <div id="zusaetzeKaeufer" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Schema der Register-/Registriernummer')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kontierungsinformation')"/>:</div>
  ...
  <xsl:template name="zusaetzeLieferung" match="xr:DELIVERY_INFORMATION">
            <div id="zusaetzeLieferung" class="box boxZweispaltig">
              <div id="BG-13" title="BG-13" class="boxtitel"><xsl:value-of select="xrf:_('Lieferinformationen')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kennung des Lieferorts')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Lieferdatum')"/>:</div>
                  <div id="BT-72" title="BT-72" class="boxdaten wert"><xsl:value-of select="format-date(xr:Actual_delivery_date,xrf:_('date-format'))"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Name des Empfängers')"/>:</div>
  ...
  <xsl:template name="zusaetzeVertrag">
            <div id="zusaetzeVertrag" class="box boxZweispaltig">
              <div class="boxtitel"><xsl:value-of select="xrf:_('Informationen zum Vertrag')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Vergabenummer')"/>:</div>
                  <div id="BT-17" title="BT-17" class="boxdaten wert"><xsl:value-of select="xr:Tender_or_lot_reference"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kennung der Empfangsbestätigung')"/>:</div>
                  <div id="BT-15" title="BT-15" class="boxdaten wert"><xsl:value-of select="xr:Receiving_advice_reference"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Kennung der Versandanzeige')"/>:</div>
                  <div id="BT-16" title="BT-16" class="boxdaten wert"><xsl:value-of select="xr:Despatch_advice_reference"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Prozesskennung')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Spezifikationskennung')"/>:</div>
  ...
  <xsl:template name="zusaetzeZahlungsempfaenger" match="xr:PAYEE">
            <div id="zusaetzeZahlungsempfaenger" class="box boxZweispaltig">
              <div id="BG-10" title="BG-10" class="boxtitel"><xsl:value-of select="xrf:_('Vom Verkäufer abweichender Zahlungsempfänger')"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Name')"/>:</div>
        ...
        <div class="boxtabelle boxabstandtop">
          <div class="boxzeile">
            <div id="anlagenListe" class="box">
              <div id="BG-24" title="BG-24" class="boxtitel"><xsl:value-of select="xrf:_('Rechnungsbegründende Unterlagen')"/></div>
  ...
  <xsl:template match="xr:ADDITIONAL_SUPPORTING_DOCUMENTS">
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Verweis (z.B. Internetadresse)')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Anhangsdokument')"/>:</div>
                  <div id="BT-125" title="BT-125" class="boxdaten wert">
		    <a href="#"
		      onClick="downloadData('{xr:Supporting_document_reference}')"><xsl:value-of select="xrf:_('Öffnen')"/></a>
		  </div>
		  <div id="{xr:Supporting_document_reference}"
		       ...
		       ><xsl:value-of select="xr:Attached_document"/></div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Format des Anhangdokuments')"/>:</div>
                  <div id="BT-125" title="BT-125" class="boxdaten wert"><xsl:value-of select="xr:Attached_document/@mime_code"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Name des Anhangsdokuments')"/>:</div>
        ...
        <div class="boxtabelle boxabstandtop">
          <div class="boxzeile">
            <div id="laufzettelHistorie" class="box">
              <div class="boxtitel"><xsl:value-of select="xrf:_('Bearbeitungshistorie')"/></div>
  ...
  <xsl:template match="xrv:laufzettelEintrag">
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Datum/Uhrzeit')"/>:</div>
                  <div class="boxdaten wert"><xsl:value-of select="format-dateTime(xrv:zeitstempel,xrf:_('datetime-format'))"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Betreff')"/>:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Text')"/>:</div>
                  <div class="boxdaten wert"><xsl:value-of select="xrv:text"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende"><xsl:value-of select="xrf:_('Details')"/>:</div>
