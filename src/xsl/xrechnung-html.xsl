...
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="/xr:invoice">
	...
	<form>
	  <div class="menue">
	    <div class="innen">
              <button type="button" class="tab" id="menueUebersicht" onclick="show(this);">{ xrf:_('Übersicht') }</button>
              <button type="button" class="tab" id="menueDetails" onclick="show(this);">{ xrf:_('Details') }</button>
              <button type="button" class="tab" id="menueZusaetze" onclick="show(this)">{ xrf:_('Zusätze') }</button>
              <button type="button" class="tab" id="menueAnlagen" onclick="show(this)">{ xrf:_('Anlagen') }</button>
              <button type="button" class="tab" id="menueLaufzettel" onclick="show(this)">{ xrf:_('Laufzettel') }</button>
	    </div>
	  </div>
	</form>
	<div class="inhalt">
  ...
  <xsl:template name="uebersicht">
	    <div id="uebersicht" class="divShow">
	      <div class="haftungausschluss">{ xrf:_('Wir übernehmen keine Haftung für die Richtigkeit der Daten.') }</div>
  ...
  <xsl:template name="uebersichtVerkaeufer" match="xr:SELLER">
            <div id="uebersichtVerkaeufer" class="box boxZweispaltig">
              <div id="BG-4" title="BG-4" class="boxtitel">{ xrf:_('Informationen zum Verkäufer') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Firmenname') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Ländercode') }:</div>
            ...
            <div id="uebersichtRechnungsinfo" class="box box1v2">
              ...
              <div class="boxtabelle boxinhalt">
                <div class="boxcell boxZweispaltig">
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('Code des Umsatzsteuer-Abrechnungsdatums') }:</div>
                    <div id="BT-8" title="BT-8" class="boxdaten wert"><xsl:value-of select="xr:Value_added_tax_point_date_code"/></div>
                  </div>
                  </div>
                  <h4>{ xrf:_('Abrechnungszeitraum') }:</h4>
                  <div class="boxtabelle borderSpacing">
                    <div class="boxzeile">
                      <div class="boxdaten legende">{ xrf:_('von') }:</div>
                    ...
                    <div class="boxzeile">
                      <div class="boxdaten legende">{ xrf:_('bis') }:</div>
  ...
  <xsl:template name="uebersichtRechnungsuebersicht">
          <div class="boxzeile">
            <div id="uebersichtRechnungsuebersicht" class="box">
              <div id="BG-22" title="BG-22" class="boxtitel">{ xrf:_('Gesamtbeträge der Rechnung') }</div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Summe aller Positionen') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Summe Nachlässe') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line1Bottom">{ xrf:_('Summe Zuschläge') }</div>
                    <div class="boxdaten rechnungSp2 paddingBottom line1Bottom color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop">{ xrf:_('Gesamtsumme') }</div>
                    <div class="boxdaten rechnungSp2 paddingTop color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Summe Umsatzsteuer') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line1Bottom">{ xrf:_('Summe Umsatzsteuer in Abrechnungswährung') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop">{ xrf:_('Gesamtsumme') }</div>
                    <div class="boxdaten rechnungSp2 paddingTop color2">{ xrf:_('brutto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Gezahlter Betrag') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('brutto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingBottom line2Bottom">{ xrf:_('Rundungsbetrag') }</div>
                    <div class="boxdaten rechnungSp2 paddingBottom line2Bottom color2">{ xrf:_('brutto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 paddingTop bold">{ xrf:_('Fälliger Betrag') }</div>
                    <div class="boxdaten rechnungSp2 paddingTop color2">{ xrf:_('brutto') }</div>
  ...
  <xsl:template name="uebersichtUmsatzsteuer" match="xr:VAT_BREAKDOWN">
          <div class="boxzeile">
            <div id="uebersichtUmsatzsteuer" class="box">
              <div id="BG-23" title="BG-23" class="boxtitel">{ xrf:_('Aufschlüsselung der Umsatzsteuer auf Ebene der Rechnung') }</div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold">{ xrf:_('Umsatzsteuerkategorie') }: <span id="BT-118" title="BT-118"><xsl:value-of select="xr:VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Gesamtsumme') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 line1Bottom">{ xrf:_('Umsatzsteuersatz') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Umsatzsteuerbetrag') }</div>
                    <div class="boxdaten rechnungSp2 color2"></div>
              ...
              <div class="grund">
                <div>{ xrf:_('Befreiungsgrund') }: <span id="BT-120" title="BT-120" class="bold"><xsl:value-of select="xr:VAT_exemption_reason_text"/></span></div>
                <div>{ xrf:_('Kennung für den Befreiungsgrund') }: <span id="BT-121"  title="BT-121" class="bold"><xsl:value-of select="xr:VAT_exemption_reason_code"/></span></div>
              </div>
            </div>
	  </div>
  </xsl:template>
  ...
  <xsl:template name="uebersichtNachlass" match="xr:DOCUMENT_LEVEL_ALLOWANCES">
          <div class="boxzeile">
            <div id="uebersichtNachlass" class="box">
              <div id="BG-20" title="BG-20" class="boxtitel">{ xrf:_('Nachlass auf Ebene der Rechnung') }</div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold">{ xrf:_('Umsatzsteuerkategorie des Nachlasses') }: <span title="BT-95"><xsl:value-of select="xr:Document_level_allowance_VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Grundbetrag') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 line1Bottom">{ xrf:_('Prozentsatz') }</div>
                    <div class="boxdaten rechnungSp2 color2 line1Bottom"></div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Nachlass') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Umsatzsteuersatz des Nachlasses') }</div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-96" title="BT-96" class="boxdaten rechnungSp3"><xsl:value-of select="xr:Document_level_allowance_VAT_rate"/></div>
                  </div>
              </div>
              <div class="grund">
                <div>{ xrf:_('Grund für den Nachlass') }: <span id="BT-97" title="BT-97" class="bold"><xsl:value-of select="xr:Document_level_allowance_reason"/></span></div>
                <div>{ xrf:_('Document level allowance reason code') }: <span id="BT-98" title="BT-98" class="bold"><xsl:value-of select="xr:Document_level_allowance_reason_code"/></span></div>
              </div>
            </div>
	  </div>
	  <div class="boxabstand"></div>
  ...
  <xsl:template name="uebersichtZuschlaege" match="xr:DOCUMENT_LEVEL_CHARGES">
          <div class="boxzeile">
            <div id="uebersichtZuschlaege" class="box">
              <div id="BG-21" title="BG-21" class="boxtitel">{ xrf:_('Zuschlag auf Ebene der Rechnung') }</div>
              <div class="boxtabelle boxinhalt">
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1 bold">{ xrf:_('Umsatzsteuerkategorie des Zuschlages') }: <span title="BT-102"><xsl:value-of select="xr:Document_level_charge_VAT_category_code"/></span></div>
                    <div class="boxdaten rechnungSp2"></div>
                    <div class="boxdaten rechnungSp3"></div>
                  </div>
                  <div class="rechnungsZeile">
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Zuschlag') }</div>
                    <div class="boxdaten rechnungSp2 color2">{ xrf:_('netto') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten rechnungSp1">{ xrf:_('Umsatzsteuersatz des Zuschlages') }</div>
                    <div class="boxdaten rechnungSp2 color2"></div>
                    <div id="BT-103" title="BT-103" class="boxdaten rechnungSp3"><xsl:value-of select="xr:Document_level_charge_VAT_rate"/></div>
                  </div>
              </div>
              <div class="grund">
                <div>{ xrf:_('Grund für den Zuschlag') }: <span id="BT-104" title="BT-104" class="bold"><xsl:value-of select="xr:Document_level_charge_reason"/></span></div>
                <div>{ xrf:_('Document level charge reason code') }: <span id="BT-105" title="BT-105" class="bold"><xsl:value-of select="xr:Document_level_charge_reason_code"/></span></div>
              </div>
            </div>
	  </div>
	  <div class="boxabstand"></div>
  ...
  <xsl:template name="uebersichtZahlungsinformationen">
            <div id="uebersichtZahlungsinformationen" class="box subBox">
              <div title="" class="boxtitel">{ xrf:_('Zahlungsdaten') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Skonto; weitere Zahlungsbedingungen') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Fälligkeitsdatum') }:</div>
  ...
  <xsl:template name="uebersichtCard">
            <div id="uebersichtCard" class="box subBox">
              <div id="BG-18" title="BG-18" class="boxtitel boxtitelSub">{ xrf:_('Karteninformation') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Kartennummer') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Karteninhaber') }:</div>
  ...
  <xsl:template name="uebersichtLastschrift">
            <div id="uebersichtLastschrift" class="box subBox">
              <div id="BG-19" title="BG-19" class="boxtitel boxtitelSub">{ xrf:_('Lastschrift') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Mandatsreferenznr.') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('IBAN') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Gläubiger-ID') }:</div>
  ...
  <xsl:template name="uebersichtUeberweisung">
            <div id="uebersichtUeberweisung" class="box subBox">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                 <div class="boxzeile">
                   <div class="boxdaten legende">{ xrf:_('Kontoinhaber') }:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('BIC') }:</div>
  ...
  <xsl:template name="uebersichtBemerkungen" match="xr:INVOICE_NOTE">
            <div id="uebersichtBemerkungen" class="box">
              <div id="BG-1" title="BG-1" class="boxtitel">{ xrf:_('Bemerkung zur Rechnung') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                 <div class="boxzeile">
                   <div class="boxdaten legende">{ xrf:_('Betreff') }:</div>
                    <div id="BT-21" title="BT-21" class="boxdaten wert"><xsl:value-of select="xr:Invoice_note_subject_code"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('Bemerkung') }:</div>
  ...
  <xsl:template match="xr:INVOICE_LINE | xr:SUB_INVOICE_LINE">
        <div class="boxtabelle boxabstandtop boxtabelleZweispaltig first">
          <div class="boxzeile">
            <div class="box subBox">
              <div id="BT-126" title="BT-126" class="boxtitel">{ xrf:_('Position') } <xsl:value-of select="xr:Invoice_line_identifier"/></div>
              <div class="boxtabelle boxinhalt borderSpacing">
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('Freitext') }:</div>
                    <div id="BT-127" title="BT-127" class="boxdaten wert"><xsl:value-of select="xr:Invoice_line_note"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('Objektkennung') }:</div>
                    <div id="BT-128" title="BT-128" class="boxdaten wert"><xsl:value-of select="xr:Invoice_line_object_identifier"/></div>
                  </div>
                  <div class="boxzeile">
                    <div class="boxdaten legende">{ xrf:_('Schema der Objektkennung') }:</div>
            ...
            <div class="box subBox">
              <div id="BG-29" title="BG-29" class="boxtitel boxtitelSub">{ xrf:_('Preiseinzelheiten') }</div>
              <div class="boxtabelle boxinhalt">
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2">{ xrf:_('Menge') }</div>
                  <div id="BT-129" title="BT-129" class="boxdaten detailSp2"><xsl:value-of select="xr:Invoiced_quantity"/></div>
                </div>
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2">{ xrf:_('Einheit') }</div>
                  <div id="BT-130" title="BT-130" class="boxdaten detailSp2"><xsl:value-of select="xr:Invoiced_quantity_unit_of_measure_code"/></div>
                </div>
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 line1Bottom color2">{ xrf:_('Preis pro Einheit (netto)') }</div>
                ...
                <div class="rechnungsZeile">
                  <div class="boxdaten detailSp1 color2">{ xrf:_('Gesamtpreis (netto)') }</div>
              ...
              <div class="boxtabelle boxinhalt noPaddingTop borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende ">{ xrf:_('Rabatt (netto)') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende ">{ xrf:_('Listenpreis (netto)') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende ">{ xrf:_('Umsatzsteuer') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende ">{ xrf:_('Umsatzsteuersatz in Prozent') }:</div>
        ...
        <div class="boxtabelle">
          <div class="boxzeile">
            <div class="box subBox">
              <div id="BG-27" title="BG-27" class="boxtitel boxtitelSub">{ xrf:_('Nachlässe auf Ebene der Rechnungsposition') }</div>
              <xsl:for-each select = "xr:INVOICE_LINE_ALLOWANCES">
                <div class="boxtabelle boxinhalt ">
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2">{ xrf:_('Grundbetrag (netto)') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 line1Bottom color2">{ xrf:_('Prozentsatz') }</div>
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2">{ xrf:_('Nachlass (netto)') }</div>
                ...
                <div class="grundDetail">
                  <div class="color2">{ xrf:_('Grund des Nachlasses') }: <span id="BT-139" title="BT-139" class="bold"><xsl:value-of select="xr:Invoice_line_allowance_reason"/></span></div>
                  <div class="color2">{ xrf:_('Code für den Nachlassgrund') }: <span id="BT-140" title="BT-140" class="bold"><xsl:value-of select="xr:Invoice_line_allowance_reason_code"/></span></div>
                </div>
              </xsl:for-each>
            </div>
            <div class="box subBox">
              <div id="BG-28" title="BG-28" class="boxtitel boxtitelSub">{ xrf:_('Zuschläge auf Ebene der Rechnungsposition') }</div>
              <xsl:for-each select = "xr:INVOICE_LINE_CHARGES">
                <div class="boxtabelle boxinhalt ">
                  ...
                  <div class="rechnungsZeile">
                    <div class="boxdaten detailSp1 color2">{ xrf:_('Zuschlag (netto)') }</div>
                ...
                <div class="grundDetail">
                  <div class="color2">{ xrf:_('Grund des Zuschlags') }: <span id="BT-144" title="BT-144" class="bold"><xsl:value-of select="xr:Invoice_line_charge_reason"/></span></div>
                  <div class="color2">{ xrf:_('Code für den Zuschlagsgrund') }: <span id="BT-145" title="BT-145" class="bold"><xsl:value-of select="xr:Invoice_line_charge_reason_code"/></span></div>
                </div>
              </xsl:for-each>
            </div>
          </div>
		    ...
		    <xsl:apply-templates select="xr:ITEM_INFORMATION/xr:ITEM_ATTRIBUTES" />
                ...
                <div class="boxcell boxZweispaltig">
                 <div class="boxtabelle borderSpacing">
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende ">{ xrf:_('Code der Artikelklassifizierung') }:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende ">{ xrf:_('Kennung zur Bildung des Schemas') }:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende ">{ xrf:_('Version zur Bildung des Schemas') }:</div>
                  ...
                  <div class="boxzeile">
                    <div class="boxdaten legende ">{ xrf:_('Code des Herkunftslandes') }:</div>
  ...
  <xsl:template name="zusaetzeVerkaeufer" match="xr:SELLER" mode="zusaetze">
            <div id="zusaetzeVerkaeufer" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Abweichender Handelsname') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Elektronische Adresse') }:</div>
                  <div id="BT-34" title="BT-34" class="boxdaten wert"><xsl:value-of select="xr:Seller_electronic_address"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Schema der elektronischen Adresse') }:</div>
  ...
  <xsl:template name="zusaetzeSteuervertreter" match="xr:SELLER_TAX_REPRESENTATIVE_PARTY">
            <div id="zusaetzeSteuervertreter" class="box boxZweispaltig">
              <div id="BG-11" title="BG-11" class="boxtitel">{ xrf:_('Steuervertreter des Verkäufers') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Name') }:</div>
  ...
  <xsl:template name="zusaetzeKaeufer" match="xr:BUYER" mode="zusaetze">
            <div id="zusaetzeKaeufer" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Schema der Register-/Registriernummer') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Kontierungsinformation') }:</div>
  ...
  <xsl:template name="zusaetzeLieferung" match="xr:DELIVERY_INFORMATION">
            <div id="zusaetzeLieferung" class="box boxZweispaltig">
              <div id="BG-13" title="BG-13" class="boxtitel">{ xrf:_('Lieferinformationen') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Kennung des Lieferorts') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Lieferdatum') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Name des Empfängers') }:</div>
  ...
  <xsl:template name="zusaetzeVertrag">
            <div id="zusaetzeVertrag" class="box boxZweispaltig">
              ...
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Spezifikationskennung') }:</div>
  ...
  <xsl:template name="zusaetzeZahlungsempfaenger" match="xr:PAYEE">
            <div id="zusaetzeZahlungsempfaenger" class="box boxZweispaltig">
              <div id="BG-10" title="BG-10" class="boxtitel">{ xrf:_('Vom Verkäufer abweichender Zahlungsempfänger') }</div>
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Name') }:</div>
        ...
        <div class="boxtabelle boxabstandtop">
          <div class="boxzeile">
            <div id="anlagenListe" class="box">
              <div id="BG-24" title="BG-24" class="boxtitel">{ xrf:_('Rechnungsbegründende Unterlagen') }</div>
  ...
  <xsl:template match="xr:ADDITIONAL_SUPPORTING_DOCUMENTS">
              <div class="boxtabelle boxinhalt borderSpacing">
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Verweis (z.B. Internetadresse)') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Anhangsdokument') }:</div>
                  <div id="BT-125" title="BT-125" class="boxdaten wert">
		    <a href="#"
		      onClick="downloadData('{xr:Supporting_document_reference}')">{ xrf:_('Öffnen') }</a>
		  </div>
		  <div id="{xr:Supporting_document_reference}"
		       ...
		       ><xsl:value-of select="xr:Attached_document"/></div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Format des Anhangdokuments') }:</div>
                  <div id="BT-125" title="BT-125" class="boxdaten wert"><xsl:value-of select="xr:Attached_document/@mime_code"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Name des Anhangsdokuments') }:</div>
        ...
        <div class="boxtabelle boxabstandtop">
          <div class="boxzeile">
            <div id="laufzettelHistorie" class="box">
              <div class="boxtitel">{ xrf:_('Bearbeitungshistorie') }</div>
  ...
  <xsl:template match="xrv:laufzettelEintrag">
              <div class="boxtabelle boxinhalt borderSpacing">
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Datum/Uhrzeit') }:</div>
                ...
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Text') }:</div>
                  <div class="boxdaten wert"><xsl:value-of select="xrv:text"/></div>
                </div>
                <div class="boxzeile">
                  <div class="boxdaten legende">{ xrf:_('Details') }:</div>
