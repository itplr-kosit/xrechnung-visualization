          ...
          <div class="menue">
            <div class="innen">
              <button type="button" class="tab" id="menueUebersicht" onclick="show(this);">
                <xsl:value-of select="xrf:_('Übersicht')" />
              </button>
              ...
              <button type="button" class="tab" id="menueZusaetze" onclick="show(this)">
                <xsl:value-of select="xrf:_('Zusätze') " />
              </button>
      ...
      <div id="uebersichtRechnungsuebersicht" class="box">
        ...
        <div class="boxtabelle boxinhalt">
          <div class="rechnungsZeile">
            ...
            <div class="boxdaten rechnungSp2 color2">
          ...
          <div class="rechnungsZeile">
            ...
            <div class="boxdaten rechnungSp2 paddingTop color2">
              <xsl:value-of select="xrf:_('netto')" />
            </div>
          ...
          <div class="rechnungsZeile">
            ...
            <div id="BT-113" title="BT-113" class="boxdaten rechnungSp3">
              <xsl:value-of select="format-number(xr:DOCUMENT_TOTALS/xr:Paid_amount,$amount-picture,$lang)" />
            </div>
          </div>
          <div class="rechnungsZeile">
            ...
            <div class="boxtabelle boxinhalt ">
              ...
              <div class="rechnungsZeile">
                ...
                <div id="BT-141" title="BT-141" class="boxdaten detailSp2 bold">
                  <xsl:value-of select="format-number(xr:Invoice_line_charge_amount,$amount-picture,$lang)" />
                </div>
              </div>
            </div>
            <div class="grundDetail">
