...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xd:doc scope="stylesheet">
      <xd:desc>
         ...
         <xd:b>Fassung vom: 2018-11-02+01:00</xd:b>
   ...
   <xsl:template mode="BG-20"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der Pfad /Invoice:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = 'false'] der Instanz in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates mode="BT-95"
                              select="./cac:TaxCategory/cbc:ID[parent::cac:TaxCategory/cbc:ChargeIndicator = 'false' and following-sibling::cac:TaxScheme/cbc:ID = 'VAT']"/>
         <xsl:apply-templates mode="BT-96"
                              select="./cac:TaxCategory/cbc:Percent[parent::cac:TaxCategory/cbc:ChargeIndicator = 'false']"/>
   ...
   <xsl:template mode="BT-95"
                 match="/Invoice:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:ID[parent::cac:TaxCategory/cbc:ChargeIndicator = 'false' and following-sibling::cac:TaxScheme/cbc:ID = 'VAT']">
   ...
   <xsl:template mode="BT-96"
                 match="/Invoice:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:Percent[parent::cac:TaxCategory/cbc:ChargeIndicator = 'false']">
   ...
   <xsl:template mode="BG-21"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der Pfad /Invoice:Invoice/cac:AllowanceCharge[cbc:ChargeIndicator = 'true'] der Instanz in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates mode="BT-102"
                              select="./cac:TaxCategory/cbc:ID[parent::cac:TaxCategory/cbc:ChargeIndicator = 'true']"/>
   ...
   <xsl:template mode="BT-102"
                 match="/Invoice:Invoice/cac:AllowanceCharge/cac:TaxCategory/cbc:ID[parent::cac:TaxCategory/cbc:ChargeIndicator = 'true']">
